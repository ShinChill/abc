...
@endphp
<script src="{{ asset('/themes/bcco/js/data.js') }}"></script>
    ...
    <div class="container-fluid">
        <nav class="navbar navbar-expand-lg">
            ...
            <div class="collapse navbar-collapse" id="main-nav">
                            ...
                            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children">
                                ...
                                <ul class="sub-menu">
                                    @foreach ($item['children'] as $children)
                                        <li class="menu-item menu-item-type-taxonomy menu-item-object-movie_country">
                ...
                <div class="navbar-right" id="msearch">
                    <form class="form-search" action="/" role="search" method="get">
         <div class="form-search__input">
                 <input type="text" name="search" placeholder="Bạn cần tìm phim ???" class="ui-autocomplete-input" autocomplete="off" value="{{ request('search') }}">
                 <div class="form-search__autocomplete">
                    <ul id="ui-id-1" tabindex="0" class="ui-menu ui-widget ui-widget-content ui-autocomplete ui-front" unselectable="on" style="display: none;">
                </ul></div>
           </div>
                <button type="submit"><svg viewBox="0 0 25 25"><use xlink:href="https://phimvsub.com/wp-content/themes/pchill/img/icons.svg"></use></svg></button>
                </form>              
              </div>
